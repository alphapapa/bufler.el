...
+ Auto-group ~parent-project~ expands the directory name.  ([[https://github.com/alphapapa/bufler.el/issues/95][#95]].  Thanks to [[https://github.com/mithraen][Denis Smirnov]] for reporting.)
